...
// アクティブ化距離（px）
var ACTIVE_RANGE = 200;

// ステージ毎の敵初期配置
// x,y はタイル座標（32px単位）× ピクセル換算済み
var STAGE_ENEMIES = {
1: [
// 近くのエリア（プレイヤー初期位置付近）
{id:‘slime’,   x:380, y:420},{id:‘slime’,   x:480, y:580},
{id:‘bat’,     x:620, y:340},
// 中距離エリア
{id:‘goblin’,  x:200, y:250},{id:‘goblin’,  x:780, y:480},
{id:‘slime’,   x:160, y:550},{id:‘bat’,     x:900, y:200},
// 遠距離エリア
{id:‘troll’,   x:150, y:800},{id:‘goblin’,  x:850, y:750},
{id:‘slime’,   x:600, y:820},{id:‘bat’,     x:300, y:860}
],
2: [
{id:‘goblin’,  x:320, y:260},{id:‘wolf’,    x:580, y:320},
{id:‘goblin’,  x:180, y:480},{id:‘skeleton’,x:700, y:420},
{id:‘wolf’,    x:420, y:620},{id:‘troll’,   x:820, y:280},
{id:‘skeleton’,x:260, y:780},{id:‘wolf’,    x:760, y:700},
{id:‘troll’,   x:500, y:880},{id:‘skeleton’,x:140, y:820}
],
3: [
{id:‘wolf’,    x:300, y:280},{id:‘bat’,     x:640, y:240},
{id:‘skeleton’,x:460, y:460},{id:‘wolf’,    x:780, y:360},
{id:‘dragon’,  x:560, y:620},{id:‘troll’,   x:220, y:620},
{id:‘bat’,     x:880, y:520},{id:‘goblin’,  x:380, y:800},
{id:‘skeleton’,x:720, y:780},{id:‘wolf’,    x:120, y:780}
],
4: [
{id:‘scorpion’,x:340, y:300},{id:‘sandworm’,x:660, y:260},
{id:‘scorpion’,x:200, y:500},{id:‘dragon’,  x:780, y:420},
{id:‘sandworm’,x:480, y:620},{id:‘scorpion’,x:880, y:300},
{id:‘wolf’,    x:280, y:780},{id:‘skeleton’,x:720, y:700},
{id:‘scorpion’,x:560, y:860},{id:‘dragon’,  x:140, y:680}
]
};
...
// ── アクティブ状態管理 ──
// ボスは最初からアクティブ、通常敵は非アクティブで待機
e.isActive=isBoss?true:false;
if(!isBoss){
e.setAlpha(0.45);  // 非アクティブは半透明
e.body.enable=false; // 物理を一時無効（衝突しない）
}

// HPバー（非アクティブ時は非表示）
e.hpBg  =this.add.rectangle(x,y-30,40,6,0x111111).setDepth(6).setVisible(false);
e.hpFill=this.add.rectangle(x,y-30,40,6,0x2ecc71).setDepth(7).setVisible(false);
return e;
};

// 敵をアクティブ化
GameScene.prototype.activateEnemy=function(e){
if(e.isActive)return;
e.isActive=true;
e.body.enable=true;
e.hpBg.setVisible(true);
e.hpFill.setVisible(true);
// アクティブ化演出：フラッシュしながら不透明に
this.tweens.add({
targets:e, alpha:1, duration:300, ease:‘Power2’
});
// 「！」マーク表示
var excl=this.add.text(e.x, e.y-e.displayHeight/2-16, ‘!’, {
fontSize:‘18px’, fontFamily:‘Courier New’, fontStyle:‘bold’,
color:’#ff4444’, stroke:’#000’, strokeThickness:3
}).setOrigin(0.5).setDepth(15);
this.tweens.add({
targets:excl, y:excl.y-24, alpha:0, duration:600,
onComplete:function(){excl.destroy();}
});
};
...
if(!enemy.active||!enemy.isActive||enemy.acd>0)return;
...
if(!e.isActive){
  if(dist<=ACTIVE_RANGE){
    self.activateEnemy(e);
  } else {
    // 非アクティブ：待機（ゆっくりふわふわ）
    var wobble=Math.sin(time*0.001+e.x)*8;
    e.setVelocity(wobble, 0);
    return;
  }
}
